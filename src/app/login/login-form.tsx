...
export function LoginForm({ showError = false }: { showError?: boolean }) {
  return (
    <form action={login} className="grid gap-4">
      ...
      {showError ? <p className="rounded-md bg-clay/10 px-3 py-2 text-sm font-medium text-clay">That email or password did not match an active account.</p> : null}
