    ...
    <main className="grid min-h-screen place-items-center bg-cream px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-6">
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-normal text-ink">Operations prototype</h1>
          <p className="mt-3 text-sm leading-6 text-ink/65">Sign in with the seeded owner account, then create employee accounts and choose permissions.</p>
        </div>
        <Card>
          <form
          ...
          >
            <label className="grid gap-1.5 text-sm font-medium text-ink/75">
              Email
              <input className={inputClass} name="email" type="email" defaultValue="dothman12@gmail.com" required />
            </label>
            <label className="grid gap-1.5 text-sm font-medium text-ink/75">
              Password
              <input className={inputClass} name="password" type="password" defaultValue="602Admin!" required />
            </label>
          ...
          <div className="mt-5 rounded-md bg-mint p-3 text-sm text-moss">
            Owner demo: <strong>dothman12@gmail.com</strong> / <strong>602Admin!</strong>
          </div>
        </Card>
      </div>
    </main>
